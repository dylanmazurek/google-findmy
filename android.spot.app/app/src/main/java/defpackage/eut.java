...
public class eut extends ag implements lsc {
    ...
    protected final void aI() {
        if (!this.e) {
            ...
            eur eurVar = (eur) this;
            dwh dwhVar = (dwh) r();
            eurVar.aq = new dhx((mko) dwhVar.b);
            eurVar.ar = new gok((mko) dwhVar.b, (mko) dwhVar.j.l);
            eurVar.as = (elo) dwhVar.i.l.a();
            eurVar.ao = (bym) dwhVar.i.ap.a();
            eurVar.b = (dyr) dwhVar.j.g.a();
            eurVar.an = (hpd) dwhVar.i.au.a();
            eurVar.c = jdl.a;
        }
    }
