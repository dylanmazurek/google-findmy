...
public final class jzk implements Runnable {
    Runnable a;
    final /* synthetic */ jzl b;

    public jzk(jzl jzlVar) {
        this.b = jzlVar;
    }

    /* JADX WARN: Code restructure failed: missing block: B:11:0x0047, code lost:            r1 = r1 | java.lang.Thread.interrupted();        r0 = null;     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0049, code lost:            r11.a.run();     */
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0054, code lost:            r3 = move-exception;     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0081, code lost:            r11.a = null;     */
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0083, code lost:            throw r3;     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0056, code lost:            r3 = move-exception;     */
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0058, code lost:            defpackage.jzl.a.a().logp(java.util.logging.Level.SEVERE, "com.google.common.util.concurrent.SequentialExecutor$QueueWorker", "workOnQueue", "Exception while executing runnable " + java.lang.String.valueOf(r11.a), (java.lang.Throwable) r3);     */
    /* JADX WARN: Code restructure failed: missing block: B:25:0x007e, code lost:            r11.a = null;     */
    /* JADX WARN: Code restructure failed: missing block: B:32:0x0041, code lost:            return;     */
    ...
    */
    public final void run() {
        ...
        L56:
            r3 = move-exception
            r9 = r3
            jyy r3 = defpackage.jzl.a     // Catch: java.lang.Throwable -> L54
        ...
        L91:
            ...
            monitor-enter(r1)
            jzl r3 = r11.b     // Catch: java.lang.Throwable -> L9d
    ...
    public final String toString() {
        ...
        if (runnable != null) {
            return der.c(runnable, "SequentialExecutorWorker{running=", "}");
        }
        int i = this.b.d;
        if (i != 1) {
            if (i != 2) {
        ...
        return a.ag(str, "SequentialExecutorWorker{state=", "}");
    }
}
