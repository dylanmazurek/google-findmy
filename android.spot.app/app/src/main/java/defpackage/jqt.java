...
public enum jqt {
    ...
    static {
        ...
        for (jqt jqtVar : values()) {
            if (hashMap.put(Character.valueOf(jqtVar.G), jqtVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(String.valueOf(jqtVar))));
            }
        }
