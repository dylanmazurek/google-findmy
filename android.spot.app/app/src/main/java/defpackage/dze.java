...
public class dze extends ag implements lsc {
    ...
    protected final void d() {
        if (!this.e) {
            ...
            dwh dwhVar = (dwh) r();
            ag agVar = dwhVar.a;
            dzbVar.c = new bso(agVar, new bso(agVar, (dhx) ((lsi) dwhVar.c).b, (dhx) ((lsi) dwhVar.d).b), (ddg) dwhVar.i.ab.a());
            dzbVar.b = (ewf) dwhVar.i.av.a();
            dzbVar.d = (ddg) dwhVar.i.ab.a();
        }
    }
