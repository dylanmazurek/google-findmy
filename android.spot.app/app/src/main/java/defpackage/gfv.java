...
public final class gfv extends BroadcastReceiver {
    final /* synthetic */ jfe a;
    final /* synthetic */ Account b;

    public gfv(jfe jfeVar, Account account) {
        this.a = jfeVar;
        this.b = account;
    }

    /* JADX WARN: Type inference failed for: r0v1, types: [gfu, java.lang.Object] */
