...
public class dvd extends ag implements lsc {
    ...
    protected final void a() {
        if (!this.e) {
            ...
            dvg dvgVar = (dvg) this;
            dwh dwhVar = (dwh) r();
            Object obj = dwhVar.i.aS.b;
            dvgVar.a = (dyq) dwhVar.j.h.a();
            dvgVar.b = (ewc) dwhVar.i.h.a();
            dvgVar.e = (dyw) dwhVar.i.ah.a();
            dvgVar.af = (emx) dwhVar.i.P.a();
            dwf dwfVar = dwhVar.j;
            dwj dwjVar = dwfVar.m;
            dvgVar.c = new jms(new dvb((Context) dwjVar.aS.b, (nca) dwfVar.j.a()));
        }
    }
