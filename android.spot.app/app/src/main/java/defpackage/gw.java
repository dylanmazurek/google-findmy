...
public final class gw extends fy implements Menu {
    private final bsp c;

    public gw(Context context, bsp bspVar) {
        super(context);
        this.c = bspVar;
    }
    ...
    public final void removeGroup(int i) {
        if (this.b != null) {
            ...
            while (true) {
                ...
                if (((bsq) taVar.c(i2)).getGroupId() == i) {
                    this.b.d(i2);
                    i2--;
                }
                i2++;
    ...
    public final MenuItem add(int i, int i2, int i3, CharSequence charSequence) {
        return a(((gh) this.c).c(i, i2, i3, charSequence));
    }
