...
public class irn extends ko {
    ...
    public irn(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public irn(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = true;
        this.b = false;
        TypedArray a = isa.a(context, attributeSet, irr.b, i, 0, new int[0]);
