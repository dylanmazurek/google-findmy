...
public class eaa extends ag implements lsc {
    ...
    /* JADX WARN: Type inference failed for: r2v29, types: [lsm, java.lang.Object] */
    protected final void a() {
        if (!this.e) {
            this.e = true;
            dzo dzoVar = (dzo) this;
            dwh dwhVar = (dwh) r();
            dzoVar.b = lsg.b(dwhVar.f);
            dzoVar.aj = (ewf) dwhVar.i.i.a();
            dzoVar.ak = (emz) dwhVar.i.ay.a();
            dzoVar.ap = (dhx) dwhVar.i.k.a();
            dzoVar.c = (evo) dwhVar.i.az.a();
            dzoVar.d = dwhVar.a();
            dzoVar.al = (exa) dwhVar.i.aB.a();
            dwf dwfVar = dwhVar.j;
            Activity a = dwfVar.a();
            kuv kuvVar = (kuv) iqg.o((Context) dwfVar.m.aS.b).d.a();
            kuvVar.getClass();
            dzoVar.am = new dwo(a, kuvVar);
            dzoVar.an = (dxf) dwhVar.i.w.a();
        }
    }
