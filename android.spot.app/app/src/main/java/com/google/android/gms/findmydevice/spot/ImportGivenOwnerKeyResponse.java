...
public final class ImportGivenOwnerKeyResponse extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new fnk(17);
    public boolean a;

    private ImportGivenOwnerKeyResponse() {
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ImportGivenOwnerKeyResponse) {
            return amr.g(Boolean.valueOf(this.a), Boolean.valueOf(((ImportGivenOwnerKeyResponse) obj).a));
        }
        return false;
    }
